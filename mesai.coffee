...
module.exports = (robot) ->
  ...
  robot.hear /mesai/i, (msg) ->
    ...
    minutesLeft = (new Number(hafiza[username]["endofshiftMM"]) - Math.abs(minutesLeft) + new Number(hafiza[username]["endofshiftMM"])) if minutesLeft < 0 and hafiza[username]["endofshiftMM"] < 60
